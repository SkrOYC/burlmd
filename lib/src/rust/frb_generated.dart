...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -655763771;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiFfiApiClearCorruptActiveWorkspaceSessionSnapshot();
  ...
  String crateApiFfiApiCopyWholeNoteAsMarkdown({required String noteId});
  ...
  RangeEditResult crateApiFfiApiDeleteWholeNote({required String noteId});
  ...
  crateApiFfiApiLoadActiveWorkspaceSessionSnapshot();
  ...
  Future<LinkTargetResolution> crateApiFfiApiResolveLinkTarget({
    required String targetId,
  });

  Future<void> crateApiFfiApiSaveActiveWorkspaceSessionSnapshot({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiFfiApiClearCorruptActiveWorkspaceSessionSnapshot() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiFfiApiClearCorruptActiveWorkspaceSessionSnapshotConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiFfiApiClearCorruptActiveWorkspaceSessionSnapshotConstMeta =>
      const TaskConstMeta(
        debugName: "clear_corrupt_active_workspace_session_snapshot",
        argNames: [],
      );
  ...
  String crateApiFfiApiCopyWholeNoteAsMarkdown({required String noteId}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiFfiApiCopyWholeNoteAsMarkdownConstMeta,
        argValues: [noteId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiApiCopyWholeNoteAsMarkdownConstMeta =>
      const TaskConstMeta(
        debugName: "copy_whole_note_as_markdown",
        argNames: ["noteId"],
      );
  ...
  TaskConstMeta get kCrateApiFfiApiCreateLinkTargetConstMeta =>
      const TaskConstMeta(
        debugName: "create_link_target",
        argNames: ["targetId"],
      );
  ...
  RangeEditResult crateApiFfiApiDeleteWholeNote({required String noteId}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiFfiApiDeleteWholeNoteConstMeta,
        argValues: [noteId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiApiDeleteWholeNoteConstMeta =>
      const TaskConstMeta(debugName: "delete_whole_note", argNames: ["noteId"]);
  ...
  crateApiFfiApiLoadActiveWorkspaceSessionSnapshot() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_active_workspace_session_snapshot,
          decodeErrorData: sse_decode_app_error,
        ),
        constMeta: kCrateApiFfiApiLoadActiveWorkspaceSessionSnapshotConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiFfiApiLoadActiveWorkspaceSessionSnapshotConstMeta =>
      const TaskConstMeta(
        debugName: "load_active_workspace_session_snapshot",
        argNames: [],
      );
  ...
  RangeEditResult crateApiFfiApiReplaceWholeNote({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiFfiApiReplaceWholeNoteConstMeta,
        argValues: [noteId, replacement],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiFfiApiReplaceWholeNoteConstMeta =>
      const TaskConstMeta(
        debugName: "replace_whole_note",
        argNames: ["noteId", "replacement"],
      );
  ...
  Future<LinkTargetResolution> crateApiFfiApiResolveLinkTarget({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_link_target_resolution,
          decodeErrorData: sse_decode_app_error,
        ),
        constMeta: kCrateApiFfiApiResolveLinkTargetConstMeta,
        argValues: [targetId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiApiResolveLinkTargetConstMeta =>
      const TaskConstMeta(
        debugName: "resolve_link_target",
        argNames: ["targetId"],
      );
  ...
  Future<void> crateApiFfiApiSaveActiveWorkspaceSessionSnapshot({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_box_autoadd_active_workspace_session_snapshot(
            snapshot,
            serializer,
          );
          pdeCallFfi(
        ...
        constMeta: kCrateApiFfiApiSaveActiveWorkspaceSessionSnapshotConstMeta,
        argValues: [snapshot],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiFfiApiSaveActiveWorkspaceSessionSnapshotConstMeta =>
      const TaskConstMeta(
        debugName: "save_active_workspace_session_snapshot",
        argNames: ["snapshot"],
      );
  ...
  ActiveWorkspaceSessionSnapshot dco_decode_active_workspace_session_snapshot(
    ...
    return ActiveWorkspaceSessionSnapshot(
      openNoteIds: dco_decode_list_String(arr[0]),
      activeNoteId: dco_decode_opt_String(arr[1]),
      expandedDirectoryIds: dco_decode_list_String(arr[2]),
      searchQuery: dco_decode_String(arr[3]),
      syncPresentation: dco_decode_session_sync_presentation(arr[4]),
    );
  }
  ...
  dco_decode_box_autoadd_active_workspace_session_snapshot(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_active_workspace_session_snapshot(raw);
  }
  ...
  LinkCompletion dco_decode_link_completion(dynamic raw) {
    ...
    return LinkCompletion(
      kind: dco_decode_link_completion_kind(arr[0]),
  ...
  LinkCompletionKind dco_decode_link_completion_kind(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return LinkCompletionKind_Existing(noteId: dco_decode_String(raw[1]));
      case 1:
        return LinkCompletionKind_ProspectiveGhost(
          targetId: dco_decode_String(raw[1]),
        );
      default:
        throw Exception("unreachable");
  ...
  LinkTargetResolution dco_decode_link_target_resolution(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return LinkTargetResolution_Existing(noteId: dco_decode_String(raw[1]));
      case 1:
        return LinkTargetResolution_Missing(
          targetId: dco_decode_String(raw[1]),
          directoryPath: dco_decode_String(raw[2]),
  ...
  SessionSyncPresentation dco_decode_session_sync_presentation(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return SessionSyncPresentation.values[raw as int];
  }
  ...
  ActiveWorkspaceSessionSnapshot sse_decode_active_workspace_session_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_openNoteIds = sse_decode_list_String(deserializer);
    var var_activeNoteId = sse_decode_opt_String(deserializer);
    var var_expandedDirectoryIds = sse_decode_list_String(deserializer);
    var var_searchQuery = sse_decode_String(deserializer);
    var var_syncPresentation = sse_decode_session_sync_presentation(
      deserializer,
    );
    return ActiveWorkspaceSessionSnapshot(
      openNoteIds: var_openNoteIds,
      activeNoteId: var_activeNoteId,
      expandedDirectoryIds: var_expandedDirectoryIds,
      searchQuery: var_searchQuery,
      syncPresentation: var_syncPresentation,
    );
  }
  ...
  sse_decode_box_autoadd_active_workspace_session_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_active_workspace_session_snapshot(deserializer));
  }
  ...
  LinkCompletion sse_decode_link_completion(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_kind = sse_decode_link_completion_kind(deserializer);
  ...
  LinkCompletionKind sse_decode_link_completion_kind(
    ...
    switch (tag_) {
      case 0:
        ...
        return LinkCompletionKind_Existing(noteId: var_noteId);
      case 1:
        var var_targetId = sse_decode_String(deserializer);
        return LinkCompletionKind_ProspectiveGhost(targetId: var_targetId);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  LinkTargetResolution sse_decode_link_target_resolution(
    ...
    switch (tag_) {
      case 0:
        var var_noteId = sse_decode_String(deserializer);
        return LinkTargetResolution_Existing(noteId: var_noteId);
      case 1:
        var var_targetId = sse_decode_String(deserializer);
  ...
  SessionSyncPresentation sse_decode_session_sync_presentation(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return SessionSyncPresentation.values[inner];
  }
  ...
  void sse_encode_active_workspace_session_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_String(self.openNoteIds, serializer);
    sse_encode_opt_String(self.activeNoteId, serializer);
    sse_encode_list_String(self.expandedDirectoryIds, serializer);
    sse_encode_String(self.searchQuery, serializer);
    sse_encode_session_sync_presentation(self.syncPresentation, serializer);
  }
  ...
  void sse_encode_box_autoadd_active_workspace_session_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_active_workspace_session_snapshot(self, serializer);
  }
  ...
  void sse_encode_link_completion(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_link_completion_kind(self.kind, serializer);
  ...
  void sse_encode_link_completion_kind(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case LinkCompletionKind_Existing(noteId: final noteId):
        sse_encode_i_32(0, serializer);
        sse_encode_String(noteId, serializer);
      case LinkCompletionKind_ProspectiveGhost(targetId: final targetId):
        sse_encode_i_32(1, serializer);
        sse_encode_String(targetId, serializer);
    }
  }
  ...
  void sse_encode_link_target_resolution(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case LinkTargetResolution_Existing(noteId: final noteId):
        sse_encode_i_32(0, serializer);
        sse_encode_String(noteId, serializer);
      case LinkTargetResolution_Missing(
        targetId: final targetId,
        directoryPath: final directoryPath,
        title: final title,
      ):
        sse_encode_i_32(1, serializer);
        sse_encode_String(targetId, serializer);
