...
- **Discovered constraints:** AST references are authoritative for active use; protected Git/reconciliation states override age; credentials remain in Platform secure storage; local Note work survives Object Store failure.
