...
- Added exact ownership for `chore/epic-m-ci-foundation`, `spike/epic-h-canonical-foundations`, and `feat/epic-h-authority-foundation`. Partial H and M tranches don't archive their epics, and no unmerged branch satisfies a dependency.
