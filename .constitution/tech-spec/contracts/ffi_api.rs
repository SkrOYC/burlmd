// FORWARD STATUS (TechSpec v1.7.12-provisional): this is the delivered
// brownfield interface, not an implementation-ready contract for PRD v1.3.5
// and Architecture v1.4.11.
