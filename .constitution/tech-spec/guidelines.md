...
A candidate attempt to reserve a sealed or receipt name makes the immutable upload fail, but candidate processes lack the runtime artifact credentials needed to upload either artifact. This fresh-environment boundary, rather than a platform sandbox, keeps candidate processes and filesystem state away from OIDC and attestation steps. Bubblewrap remains the separate post-download coordinator boundary.
...
| :--- | :--- | :--- | :--- |
| `CI-M003` | Common functional, managed-evidence protocol, security, isolation, generated-binding check, static analysis, desktop integration | Common functional, managed-evidence protocol, security, static analysis, desktop integration | Common functional, managed-evidence protocol, security, static analysis, desktop integration |
| `AST-H001` | Common functional, performance, AST measurement | Common functional, performance, AST measurement | Common functional |
| `PATH-H002` | Common functional, filesystem compatibility | Common functional, filesystem compatibility | Common functional |
| `ASSET-I001` | Common functional, performance, asset measurement | Common functional, performance, asset measurement | Common functional |
| `GIT-L001` | Common functional, filesystem compatibility, Git protocol | Common functional, filesystem compatibility, Git protocol | Common functional |
| `PKG-M001` | Packaging runtime | Packaging runtime, repeatable construction | Packaging runtime compatibility |
