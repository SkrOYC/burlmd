...
verification_commands:
  ...
  - name: test
    ...
    exists: true
  - name: format
    label: canonical raw-39 verification for BURL-M003 after the pending Tasks correction
