...
Run identity is `managed:` plus the launcher's lowercase 32-hex nonce. Artifact nonce is the same 32-hex suffix. The service run ID and attempt remain separate origin fields. Required roles are `linux-x86_64`, `macos-26-arm64`, and `macos-15-arm64`.
