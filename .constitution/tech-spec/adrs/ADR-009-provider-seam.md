...
Architecture v2.1.2 makes the seam precise. Provider (`BND-14`) owns authorization, eligible private-Remote selection or provisioning, and location. Remote (`BND-20`) owns authenticated history and ref exchange. Object Store (`BND-21`) owns Object bytes through the separate `BND-11` coordinator. ADR-017 supersedes any language that assigned Git transfer to a provider module.
