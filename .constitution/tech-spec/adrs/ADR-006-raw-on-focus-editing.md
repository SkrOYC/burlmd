...
- **Negative:** While a Block is focused for editing, selection is scoped to that Block until the user drags outward. Accepted; it is the narrow residue of a limitation that would otherwise apply everywhere.
