...
> **Forward status:** This is the delivered v1.6.x bundle snapshot. Live TechSpec v2.1.17 (reviewed v1.8.7 lineage) reopens title-verbatim filenames through OD-05 and replaces the deferred Asset section with the required hybrid Local Asset Store and S3-compatible object model. SPK-BURL-H002 and SPK-BURL-I001 must settle those physical forms before final Stage 3 rewrites this contract. Research Tasks must not implement the old filename or Asset text as forward behavior.
