...
> **Forward status:** This is the delivered v1.6.x bundle contract. TechSpec v1.7.3-provisional reopens title-verbatim filenames through OD-05 and replaces the deferred attachment section with the required hybrid Local Asset Store and S3-compatible object model. SPK-PATH-H002 and SPK-ASSET-I001 must settle those physical forms before final Stage 3 rewrites this contract. Research Tasks must not implement the old filename or attachment text as forward behavior.
