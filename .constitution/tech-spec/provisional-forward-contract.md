...
| Releases and updates | Development builds plus committed Epic G headless capture | SPK-PKG-M001 for package choices; CI-M003 for managed validation bootstrap | Artifact manifests, managed reference roles, authenticated evidence aggregation, update metadata, installed-app release matrix |
