...
- Distinguished a validation role's available capabilities from a request's required evidence. Authoritative expected identity assigns the exact role-specific classes for each gate, and aggregation rejects both missing and unassigned evidence.
