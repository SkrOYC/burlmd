...
- **Risk:** Validation can capture the Writer's desktop, accept evidence from another environment, let candidate code replace its own verifier, or expose aggregation credentials to candidate-controlled code.
