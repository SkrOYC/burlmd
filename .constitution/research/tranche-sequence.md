...
2. `docs/epic-m-ci-evidence`: validate the merged anchor against itself, then review and merge only `.constitution/evidence/BURL-M003/managed-evidence.json`, `completion.md`, and `manifest.yaml`. This merge completes `BURL-M003`.
